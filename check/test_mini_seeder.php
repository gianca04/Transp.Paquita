...
use App\Models\{Area, SubArea, Categoria, Marca, Producto, Stock};

// Solo los primeros 3 productos del seeder para probar
$productos = [
    ...
    ['area' => 'Bioseguridad', 'sub' => 'Almacén EPP', 'categoria' => 'Consumibles', 'marca' => 'FARMAPRECIO', 'nombre' => 'Algodón 500g', 'descripcion' => '', 'proveedor_id' => 1, 'user_id' => 1],
    ['area' => 'Bioseguridad', 'sub' => 'Almacén EPP', 'categoria' => 'Consumibles', 'marca' => 'FARMAPRECIO', 'nombre' => 'Algodón 25g', 'descripcion' => '', 'proveedor_id' => 1, 'user_id' => 1],
];

$count = 0;
foreach ($productos as $item) {
    $count++;
    echo "=== Procesando producto $count: {$item['nombre']} ===" . PHP_EOL;
